...
export default function SignUp() {
  ...
  //Get inputs from signup form and store that in formData.Use trim method to get rid of any blank spaces.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //Define response which is a POST method to signup route with JSON data style.
